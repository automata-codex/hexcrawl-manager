...
export const ZoneSchema = z.object({
  ...
  narrative: z.array(z.string()).optional().describe('Player-facing descriptions and information'),
  clues: z.array(z.string()).optional().describe('List of knowledge keys or "unlocks"'),
});
