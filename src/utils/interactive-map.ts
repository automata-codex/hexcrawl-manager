...
export function getTravelDifficulty(biomeTag?: string, terrainType?: string): string {
...
export function getFavoredTerrain(biomeTag?: string, terrainType?: string): string {
  ...
  if (forestBiomes.has(biomeTag ?? '') && (terrainType === "mountains" || terrainType === "peak")) {
